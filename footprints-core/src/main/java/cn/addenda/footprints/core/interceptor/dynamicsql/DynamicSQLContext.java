...
import cn.addenda.footprints.core.pojo.Ternary;
...
public class DynamicSQLContext {
    ...
    public static void setInsertSelectAddItemMode(InsertSelectAddItemMode insertSelectAddItemMode) {
        Stack<DynamicSQLConfig> dynamicSQLConfigs = DYNAMIC_SQL_CONFIG_TL.get();
        DynamicSQLConfig dynamicSQLConfig = dynamicSQLConfigs.peek();
        dynamicSQLConfig.setInsertSelectAddItemMode(insertSelectAddItemMode);
    }

    public static InsertSelectAddItemMode getInsertSelectAddItemMode() {
        Stack<DynamicSQLConfig> dynamicSQLConfigs = DYNAMIC_SQL_CONFIG_TL.get();
        DynamicSQLConfig dynamicSQLConfig = dynamicSQLConfigs.peek();
        return dynamicSQLConfig.getInsertSelectAddItemMode();
    }
    ...
    public static class DynamicSQLConfig {
        ...
        public DynamicSQLConfig(DynamicSQLConfig dynamicSQLConfig) {
            ...
            this.insertSelectAddItemMode = dynamicSQLConfig.insertSelectAddItemMode;
