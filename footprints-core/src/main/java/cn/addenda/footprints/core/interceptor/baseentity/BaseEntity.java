...
public abstract class BaseEntity implements Serializable {
    ...
    protected static class LocalDateTimeStrDeSerializer extends JsonDeserializer<LocalDateTime> {
    ...
    protected static class LocalDateTimeStrSerializer extends JsonSerializer<LocalDateTime> {
