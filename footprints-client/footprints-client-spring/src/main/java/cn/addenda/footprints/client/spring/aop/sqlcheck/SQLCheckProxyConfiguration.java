...
import cn.addenda.footprints.core.interceptor.sqlcheck.SQLCheckInterceptor;
...
public class SQLCheckProxyConfiguration implements ImportAware {
    ...
    public class SQLCheckBeanPostProcessor extends AbstractFootprintsBeanPostProcessor<SQLCheckInterceptor> {
